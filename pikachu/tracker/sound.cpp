  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("sound/lavender.mp3");
  ...
  sounds.push_back( Mix_LoadWAV("sound/lightning.wav") );
  sounds.push_back( Mix_LoadWAV("sound/die.wav") );
  sounds.push_back( Mix_LoadWAV("sound/haunter.wav") );
